...
스케폴딩으로 생성된 프로젝트 구조에는 현재 단계에서 사용하지 않는 폴더와 파일이 포함되어 있다. 실습에 불필요한 항목들을 정리하자.

1. src 폴더에 있는 assets 폴더와 App.css, index.css 삭제

2. App.tsx 파일을 열고, 기존 내용을 모두 삭제한 후 아래와 같이 코드를 작성한다.
...
3. main.tsx 파일을 열고 import './index.css' 구문을 삭제한다.
